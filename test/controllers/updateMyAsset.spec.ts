...
describe('controllers - updateMyAsset', () => {
  ...
  const updateMyAssetCtrl = require('../../server/controllers/updateMyAsset');
  ...
  test('should successfully invoke transaction updateMyAsset', async () => {
    ...
    await updateMyAssetCtrl.default(req, res);
    expect(DummyUtil.sendResponse).toBeCalledWith(res, jsonRes);
  });

  test('should catch updateMyAsset error and return error', async () => {
